...
/** 
 * DAO for table "Tbl_Mob_Reponses".
*/
public class ReponsesDao extends AbstractDao<Reponses, Long> {

    public static final String TABLENAME = "Tbl_Mob_Reponses";
    ...
    */
    public static class Properties {
        ...
        public final static Property ScoreTotal = new Property(5, Double.class, "scoreTotal", false, "scoreTotal");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"Tbl_Mob_Reponses\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"Tbl_Mob_Reponses\"";
        db.execSQL(sql);
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Reponses entity) {
        ...
        Double scoreTotal = entity.getScoreTotal();
        if (scoreTotal != null) {
            stmt.bindDouble(6, scoreTotal);
        }
    ...
    public Reponses readEntity(Cursor cursor, int offset) {
        Reponses entity = new Reponses( //
            ...
            cursor.isNull(offset + 5) ? null : cursor.getDouble(offset + 5), // scoreTotal
    ...
    public void readEntity(Cursor cursor, Reponses entity, int offset) {
        ...
        entity.setScoreTotal(cursor.isNull(offset + 5) ? null : cursor.getDouble(offset + 5));
