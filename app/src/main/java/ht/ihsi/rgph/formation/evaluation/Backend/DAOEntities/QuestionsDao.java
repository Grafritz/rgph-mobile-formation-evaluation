...
/** 
 * DAO for table "Tbl_Mob_Questions".
*/
public class QuestionsDao extends AbstractDao<Questions, Long> {

    public static final String TABLENAME = "Tbl_Mob_Questions";
    ...
    */
    public static class Properties {
        ...
        public final static Property ScoreTotal = new Property(6, Double.class, "scoreTotal", false, "scoreTotal");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"Tbl_Mob_Questions\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"Tbl_Mob_Questions\"";
        db.execSQL(sql);
    }
    ...
    public Questions readEntity(Cursor cursor, int offset) {
        Questions entity = new Questions( //
            ...
            cursor.isNull(offset + 6) ? null : cursor.getDouble(offset + 6), // scoreTotal
    ...
    public void readEntity(Cursor cursor, Questions entity, int offset) {
        ...
        entity.setScoreTotal(cursor.isNull(offset + 6) ? null : cursor.getDouble(offset + 6));
