...
/** 
 * DAO for table "Tbl_Mob_Personnel".
*/
public class PersonnelDao extends AbstractDao<Personnel, Long> {

    public static final String TABLENAME = "Tbl_Mob_Personnel";
    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"Tbl_Mob_Personnel\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"Tbl_Mob_Personnel\"";
        db.execSQL(sql);
    }
