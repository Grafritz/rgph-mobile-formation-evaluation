...
/** 
 * DAO for table "tbl_Mob_vqse".
*/
public class VqseDao extends AbstractDao<Vqse, Void> {

    public static final String TABLENAME = "tbl_Mob_vqse";
    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"tbl_Mob_vqse\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"tbl_Mob_vqse\"";
        db.execSQL(sql);
    }
