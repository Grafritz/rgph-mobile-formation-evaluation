...
/** 
 * DAO for table "tbl_Mob_departement".
*/
public class DepartementDao extends AbstractDao<Departement, Void> {

    public static final String TABLENAME = "tbl_Mob_departement";
    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"tbl_Mob_departement\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"tbl_Mob_departement\"";
        db.execSQL(sql);
    }
