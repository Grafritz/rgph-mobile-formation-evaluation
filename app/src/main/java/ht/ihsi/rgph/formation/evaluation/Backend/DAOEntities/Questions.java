...
/**
 * Entity mapped to table "Tbl_Mob_Questions".
 */
public class Questions {
    ...
    public Questions(Long codeQuestion, String libelle, String detailsQuestion, String indicationsQuestion, Boolean avoirJustificationYN, Integer typeQuestion, Double scoreTotal, Integer caratereAccepte, Integer nbreValeurMinimal, Integer nbreCaratereMaximal, String qPrecedent, String qSuivant) {
        this.codeQuestion = codeQuestion;
